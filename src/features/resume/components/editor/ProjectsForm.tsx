...
import { FolderGit2, Plus, Trash2, ChevronUp, ChevronDown, Sparkles } from "lucide-react";
...
export const ProjectsForm: React.FC = () => {
  ...
  const handleAdd = () => {
    const newProj: IProject = {
      ...
      highlights: [
        "Implemented core features resulting in a 40% performance boost.",
      ],
  ...
  const addHighlight = (projId: string) => {
    ...
    updateProject(projId, {
      highlights: [
        ...(proj.highlights || []),
        "New key accomplishment or feature...",
      ],
    });
  };
          ...
          >
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                <button
                  type="button"
                  onClick={() => triggerProjectDescriptionAi(proj.id, proj.title, getTechArray(proj.technologies))}
            ...
            <div className="space-y-2 pt-2 border-t border-border">
              <div className="flex flex-wrap items-center justify-between gap-2">
                ...
                <div className="flex items-center gap-2">
                  <button
                    type="button"
                    onClick={() => triggerProjectBulletsAi(proj.id, proj.title, getTechArray(proj.technologies))}
                    ...
                    title="Generate project achievement bullets with LetGetIn AI Coach"
                  >
